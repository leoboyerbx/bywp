...
const projectQuestions = [
    ...
    },
    {
        ...
        choices: [
            ...
            {
                name: 'Structure d\'un projet PHP',
                value: "php-dirs"
            }
        ]
    },
        ...
        .then(project => {
            ...
            inquirer.prompt([
                ...
                if (answer['run-npm']) {
                    ...
                    postProcess(project.name, 'npm install')
                }
...
function checkOptions(file, project) {
    ...
    let phpDirs = ['app', 'core', 'views']
    if (phpDirs.includes(file) && !options.includes('php-dirs')) {return false}

    return true
}
function postProcess (path, command) {
    shell.cd(path)
...
module.exports.startGenerator = startGenerator()